...
For multi-color icons (like F5 XC service icons or HashiCorp Flight color variants), the `no-invert` class on `.icon-card-image` preserves original colors in dark mode.
