...
| F5 Brand | 666 | `<img src="/brand-icons/f5-icon-*.svg" />` | [F5 Brand](/brand/) |
| Lucide | ~1,600 | `<img>` via Iconify API | [Lucide](/lucide/) |
| Material Design | 7,000+ | `<img>` via Iconify API | [Iconify Packs](/iconify-packs/) |
| Carbon | ~1,500 | `<img>` via Iconify API | [Iconify Packs](/iconify-packs/) |
| Phosphor | ~1,200 | `<img>` via Iconify API | [Iconify Packs](/iconify-packs/) |
| Tabler | ~4,500 | `<img>` via Iconify API | [Iconify Packs](/iconify-packs/) |
| F5 XC Services | 30 | `<Icon>` Astro component | [F5 XC Services](/f5xc/) |
| HashiCorp Flight | 671 | `<img>` via CDN | [HashiCorp Flight](/hashicorp-flight/) |
